...
__mpfr_struct * mpfr_mat_entry__extern(const mpfr_mat_t mat, slong i, slong j) { return mpfr_mat_entry(mat, i, j); }
slong mpfr_mat_nrows__extern(const mpfr_mat_t mat) { return mpfr_mat_nrows(mat); }
slong mpfr_mat_ncols__extern(const mpfr_mat_t mat) { return mpfr_mat_ncols(mat); }
